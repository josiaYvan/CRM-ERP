...
@section('page-description', 'Gestion des services')
...
@section('main-content')
                ...
                <div class="col-sm-6 col-xl-3">
                    <div class="bg-info rounded overflow-hidden">
                        <div class="pd-x-20 pd-t-20 d-flex align-items-center">
                            ...
                            <div class="mg-l-20">
                                <p class="tx-10 tx-spacing-1 tx-mont tx-semibold tx-uppercase tx-white-8 mg-b-10">Personnel
                                </p>
                                <p class="tx-24 tx-white tx-lato tx-bold mg-b-0 lh-1">{{ count($personnel) }}</p>
            ...
            <a href="{{ route('conges.index') }}">
                ...
                <div class="bg-purple rounded overflow-hidden">
                    <div class="pd-x-20 pd-t-20 d-flex align-items-center">
                        ...
                        <div class="mg-l-20">
                            <p class="tx-10 tx-spacing-1 tx-mont tx-semibold tx-uppercase tx-white-8 mg-b-10">Congé
                            </p>
                            <p class="tx-24 tx-white tx-lato tx-bold mg-b-0 lh-1">{{ count($conge) }}</p>
            ...
            <a href="{{ route('taches.index') }}">
                <div class="bg-teal rounded overflow-hidden">
                    <div class="pd-x-20 pd-t-20 d-flex align-items-center">
                        ...
                        <div class="mg-l-20">
                            <p class="tx-10 tx-spacing-1 tx-mont tx-semibold tx-uppercase tx-white-8 mg-b-10">Tâche</p>
                            <p class="tx-24 tx-white tx-lato tx-bold mg-b-0 lh-1">{{ count($tache) }}</p>
                            <span class="tx-11 tx-roboto tx-white-8">Nombre de tâche</span>
                        </div>
                    </div>
        ...
        <div class="col-sm-6 col-xl-3 mg-t-20 mg-xl-t-0">
            <div class="bg-primary rounded overflow-hidden">
                <div class="pd-x-20 pd-t-20 d-flex align-items-center">
                    ...
                    <div class="mg-l-20">
                        <p class="tx-10 tx-spacing-1 tx-mont tx-semibold tx-uppercase tx-white-8 mg-b-10">Tâche fait
                        </p>
                        <p class="tx-24 tx-white tx-lato tx-bold mg-b-0 lh-1">{{ count($tache_done) }}</p>
                        <span class="tx-11 tx-roboto tx-white-8">Nombre de tâche effectuée</span>
                    </div>
                </div>
    ...
    <div class="row row-sm mg-t-20">
        <div class="col-lg-8">
            ...
            <div class="bg-purple mt-3 pd-30 ht-300 d-flex pos-relative align-items-center rounded">
